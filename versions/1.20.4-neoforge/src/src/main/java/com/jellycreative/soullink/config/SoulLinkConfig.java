 ...
 * Allows customization of which features are enabled and their multipliers.
 */
public class SoulLinkConfig {
    ...
    public SoulLinkConfig(ModConfigSpec.Builder builder) {
        builder.comment("Soul-Link Configuration")
               .push("features");
        
        LINK_DAMAGE = builder
                .comment("Whether damage should be shared between all players")
                .define("linkDamage", true);
        
        LINK_HEALING = builder
                .comment("Whether healing should be shared between all players")
                .define("linkHealing", true);
        
        LINK_KNOCKBACK = builder
                .comment("Whether knockback should be shared between all players")
                .define("linkKnockback", true);
        
        LINK_HUNGER = builder
                .comment("Whether hunger should be shared between all players")
                .define("linkHunger", true);
        
        LINK_INVENTORY = builder
                .comment("Whether inventory should be shared between all players")
                .define("linkInventory", true);
        
        builder.pop().push("multipliers");
        
        DAMAGE_MULTIPLIER = builder
                .comment("Multiplier for shared damage (1.0 = 100%)")
                .defineInRange("damageMultiplier", 1.0, 0.0, 10.0);
        
        HEALING_MULTIPLIER = builder
                .comment("Multiplier for shared healing (1.0 = 100%)")
                .defineInRange("healingMultiplier", 1.0, 0.0, 10.0);
        
        KNOCKBACK_MULTIPLIER = builder
                .comment("Multiplier for shared knockback (1.0 = 100%)")
                .defineInRange("knockbackMultiplier", 1.0, 0.0, 10.0);
        
        HUNGER_MULTIPLIER = builder
                .comment("Multiplier for shared hunger drain (1.0 = 100%)")
                .defineInRange("hungerMultiplier", 1.0, 0.0, 10.0);
        
        builder.pop().push("misc");
        
        SHOW_LINK_MESSAGES = builder
                .comment("Whether to show messages when link effects trigger")
                .define("showLinkMessages", false);
        
        KEEP_INVENTORY_ON_DEATH = builder
                .comment("Whether to keep the shared inventory when a player dies (recommended: true)")
